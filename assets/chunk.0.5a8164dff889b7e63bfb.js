(window.webpackJsonp_ember_auto_import_=window.webpackJsonp_ember_auto_import_||[]).push([[0],{1585:function(e,t,n){"use strict"
n.r(t),n.d(t,"registerInstallations",(function(){return G}))
var r,i=n(45),o=n.n(i),a=n(46),s=n(17),u=n(23),c=n(1586),f=((r={})["missing-app-config-values"]='Missing App configuration value: "{$valueName}"',r["not-registered"]="Firebase Installation is not registered.",r["installation-not-found"]="Firebase Installation not found.",r["request-failed"]='{$requestName} request failed with error "{$serverCode} {$serverStatus}: {$serverMessage}"',r["app-offline"]="Could not process request. Application offline.",r["delete-pending-registration"]="Can't delete installation while there is a pending registration request.",r),l=new u.ErrorFactory("installations","Installations",f)
...
return Object(s.__generator)(this,(function(i){switch(i.label){case 0:return[4,t.json()]
case 1:return n=i.sent(),r=n.error,[2,l.create("request-failed",{requestName:e,serverCode:r.code,serverMessage:r.message,serverStatus:r.status})]}}))}))}function g(e){var t=e.apiKey
return new Headers({"Content-Type":"application/json",Accept:"application/json","x-goog-api-key":t})}function v(e,t){var n=t.refreshToken,r=g(e)
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */(n)),r}function b(e){return Object(s.__awaiter)(this,void 0,void 0,(function(){var t
return Object(s.__generator)(this,(function(n){switch(n.label){case 0:return[4,e()]
case 1:return(t=n.sent()).status>=500&&t.status<600?[2,e()]:[2,t]}}))}))}function w(e,t){var n=t.fid
return Object(s.__awaiter)(this,void 0,void 0,(function(){var t,r,i,o,a,u
return Object(s.__generator)(this,(function(s){switch(s.label){case 0:return t=d(e),r=g(e),i={fid:n,authVersion:"FIS_v2",appId:e.appId,sdkVersion:"w:0.4.17"},o={method:"POST",headers:r,body:JSON.stringify(i)},[4,b((function(){return fetch(t,o)}))]
 ...
 * limitations under the License.
 */var j=/^[cdef][\w-]{21}$/
function m(){try{var e=new Uint8Array(17);(self.crypto||self.msCrypto).getRandomValues(e),e[0]=112+e[0]%16
 ...
 * limitations under the License.
 */(e)
return j.test(t)?t:""}catch(e){return""}}function O(e){return e.appName+"!"+e.appId}
/**
 * @license
 * Copyright 2019 Google LLC
 *
...
n&&n.postMessage({key:e,fid:t}),x()}(n,t)}function C(e,t){var n,r,i=S.get(e)
if(i)try{for(var o=Object(s.__values)(i),a=o.next();!a.done;a=o.next())(0,a.value)(t)}catch(e){n={error:e}}finally{try{a&&!a.done&&(r=o.return)&&r.call(o)}finally{if(n)throw n.error}}}var k=null
...
function q(){return D||(D=Object(c.openDb)("firebase-installations-database",1,(function(e){switch(e.oldVersion){case 0:e.createObjectStore(P)}}))),D}function E(e,t){return Object(s.__awaiter)(this,void 0,void 0,(function(){var n,r,i,o,a
return Object(s.__generator)(this,(function(s){switch(s.label){case 0:return n=O(e),[4,q()]
case 1:return r=s.sent(),i=r.transaction(P,"readwrite"),[4,(o=i.objectStore(P)).get(n)]
...
return Object(s.__generator)(this,(function(i){switch(i.label){case 0:return t=O(e),[4,q()]
case 1:return n=i.sent(),[4,(r=n.transaction(P,"readwrite")).objectStore(P).delete(t)]
case 2:return i.sent(),[4,r.complete]
case 3:return i.sent(),[2]}}))}))}function N(e,t){return Object(s.__awaiter)(this,void 0,void 0,(function(){var n,r,i,o,a,u
return Object(s.__generator)(this,(function(s){switch(s.label){case 0:return n=O(e),[4,q()]
case 1:return r=s.sent(),i=r.transaction(P,"readwrite"),[4,(o=i.objectStore(P)).get(n)]
case 2:return a=s.sent(),void 0!==(u=t(a))?[3,4]:[4,o.delete(n)]
...
return Object(s.__generator)(this,(function(i){switch(i.label){case 0:return[4,N(e,(function(n){var r=function(e){return L(e||{fid:m(),registrationStatus:0})}(n),i=function(e,t){if(0===t.registrationStatus){if(!navigator.onLine)return{installationEntry:t,registrationPromise:Promise.reject(l.create("app-offline"))}
...
return Object(s.__generator)(this,(function(i){switch(i.label){case 0:return i.trys.push([0,2,,7]),[4,w(e,t)]
case 1:return n=i.sent(),[2,E(e,n)]
case 2:return p(r=i.sent())&&409===r.serverCode?[4,A(e)]:[3,4]
...
case 3:return[2,{installationEntry:n,registrationPromise:t}]}}))}))}function K(e){return Object(s.__awaiter)(this,void 0,void 0,(function(){var t,n,r,i
return Object(s.__generator)(this,(function(o){switch(o.label){case 0:return[4,F(e)]
case 1:t=o.sent(),o.label=2
case 2:return 1!==t.registrationStatus?[3,5]:[4,y(100)]
case 3:return o.sent(),[4,F(e)]
...
return Object(s.__awaiter)(this,void 0,void 0,(function(){var e,i,o,a,u,c
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */(n,t),i=v(n,t),(o=r.getImmediate({optional:!0}))&&i.append("x-firebase-client",o.getPlatformInfoString()),a={installation:{sdkVersion:"w:0.4.17"}},u={method:"POST",headers:i,body:JSON.stringify(a)},[4,b((function(){return fetch(e,u)}))]
case 1:return(c=s.sent()).ok?[4,c.json()]:[3,3]
case 2:return[2,h(s.sent())]
case 3:return[4,_("Generate Auth Token",c)]
case 4:throw s.sent()}}))}))}function M(e,t){return void 0===t&&(t=!1),Object(s.__awaiter)(this,void 0,void 0,(function(){var n,r,i
return Object(s.__generator)(this,(function(o){switch(o.label){case 0:return[4,N(e.appConfig,(function(r){if(!J(r))throw l.create("not-registered")
var i=r.authToken
...
if(1===i.requestStatus)return n=function(e,t){return Object(s.__awaiter)(this,void 0,void 0,(function(){var n,r
return Object(s.__generator)(this,(function(i){switch(i.label){case 0:return[4,$(e.appConfig)]
case 1:n=i.sent(),i.label=2
case 2:return 1!==n.authToken.requestStatus?[3,5]:[4,y(100)]
...
return n=function(e,t){return Object(s.__awaiter)(this,void 0,void 0,(function(){var n,r,i
return Object(s.__generator)(this,(function(o){switch(o.label){case 0:return o.trys.push([0,3,,8]),[4,V(e,t)]
case 1:return n=o.sent(),i=Object(s.__assign)(Object(s.__assign)({},t),{authToken:n}),[4,E(e.appConfig,i)]
case 2:return o.sent(),[2,n]
case 3:return!p(r=o.sent())||401!==r.serverCode&&404!==r.serverCode?[3,5]:[4,A(e.appConfig)]
case 4:return o.sent(),[3,7]
case 5:return i=Object(s.__assign)(Object(s.__assign)({},t),{authToken:{requestStatus:0}}),[4,E(e.appConfig,i)]
...
case 4:return[2,i]}}))}))}function $(e){return N(e,(function(e){if(!J(e))throw l.create("not-registered")
var t
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function R(e,t){return Object(s.__awaiter)(this,void 0,void 0,(function(){var n,r,i,o
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */(e,t),r=v(e,t),i={method:"DELETE",headers:r},[4,b((function(){return fetch(n,i)}))]
case 1:return(o=a.sent()).ok?[3,3]:[4,_("Delete Installation",o)]
case 2:throw a.sent()
case 3:return[2]}}))}))}
/**
 * @license
...
try{for(var r=Object(s.__values)(["projectId","apiKey","appId"]),i=r.next();!i.done;i=r.next()){var o=i.value
if(!e.options[o])throw U(o)}}catch(e){t={error:e}}finally{try{i&&!i.done&&(n=r.return)&&n.call(r)}finally{if(t)throw t.error}}return{appName:e.name,projectId:e.options.projectId,apiKey:e.options.apiKey,appId:e.options.appId}}(t),platformLoggerProvider:e.getProvider("platform-logger")}
...
return Object(s.__generator)(this,(function(i){switch(i.label){case 0:return[4,B(e.appConfig)]
case 1:return t=i.sent(),n=t.installationEntry,(r=t.registrationPromise)?r.catch(console.error):M(e).catch(console.error),[2,n.fid]}}))}))}
/**
 * @license
 * Copyright 2019 Google LLC
 *
...
r&&(r.delete(t),0===r.size&&S.delete(n),x())}(n,t)}}(n,e)}}}),"PUBLIC")),e.registerVersion("@firebase/installations","0.4.17")}G(o.a)},1586:function(e,t,n){!function(e){"use strict"
...
o.onsuccess=function(){r(o.result)}})}))})),[c,l].forEach((function(e){e.prototype.getAll||(e.prototype.getAll=function(e,t){var n=this,r=[]
...
return o&&(o.onupgradeneeded=function(e){n&&n(new d(o.result,e.oldVersion,o.transaction))}),i.then((function(e){return new h(e)}))},e.deleteDb=function(e){return r(indexedDB,"deleteDatabase",[e])},Object.defineProperty(e,"__esModule",{value:!0})}(t)}}])
